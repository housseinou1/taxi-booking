...
def _create_test_city():
    ...
    pk = 91005
    cities_region, _ = CitiesRegion.objects.get_or_create(name="Driver Heatmap Region")
    locations_region, _ = LocationsRegion.objects.get_or_create(name="Driver Heatmap Region")
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            ...
            [pk, cities_region.pk, "Driver Heatmap City", "", "", True, 0, 0, now],
        )
        cursor.execute(
