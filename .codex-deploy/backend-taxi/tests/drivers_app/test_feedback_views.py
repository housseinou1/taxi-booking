...
def _create_test_city():
    ...
    pk = 91004
    cities_region, _ = CitiesRegion.objects.get_or_create(name="Driver Feedback Region")
    locations_region, _ = LocationsRegion.objects.get_or_create(name="Driver Feedback Region")
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            ...
            [pk, cities_region.pk, "Driver Feedback City", "", "", True, 0, 0, now],
        )
        cursor.execute(
