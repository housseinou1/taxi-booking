...
function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { key: "beta-link", label: "Closed Beta", path: "/admin/beta" },
    { key: "fleet-link", label: "Fleet & Performance", path: "/admin/fleet" },
    { key: "finance-ops-link", label: "Finance Operations", path: "/admin/finance-ops" },
    { key: "command-link", label: "Operations Command Center", path: "/admin/operations-command" },
    { key: "growth-link", label: "Growth & Expansion", path: "/admin/growth" },
    { key: "multi-city-link", label: "Multi-City Operations", path: "/admin/multi-city" },
    { key: "smart-pricing-link", label: "Smart Pricing & Dispatch", path: "/admin/smart-pricing" },
    { key: "trust-safety-link", label: "Trust & Safety Center", path: "/admin/trust-safety" },
    { key: "incentives-link", label: "Driver Incentive Engine", path: "/admin/incentives" },
    { key: "merchant-platform-link", label: "Merchant Platform", path: "/admin/merchant-platform" },
    { key: "partner-platform-link", label: "Partner & Franchise", path: "/admin/partner-platform" },
    { key: "customer-growth-link", label: "Customer Growth & Loyalty", path: "/admin/customer-growth" },
    { key: "ceo-master-link", label: "CEO Master Command Center", path: "/admin/ceo-master" },
    { key: "board-reports-link", label: "Board & Investor Reports", path: "/admin/board-reports" },
    { key: "compliance-governance-link", label: "Compliance & Governance", path: "/admin/compliance-governance" },
    { key: "bi-link", label: "Business Intelligence", path: "/admin/bi" },
    { key: "academy-link", label: "YALA Academy", path: "/admin/academy" },
    { key: "support-center-link", label: "Support Center", path: "/admin/support" },
    { key: "business-accounts-link", label: "Business Accounts", path: "/admin/business-accounts" },
    { key: "business-link", label: "Business Operations", path: "/admin/business" },
